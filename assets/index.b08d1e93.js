 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,j){var D=P.length;P.push(j);e:for(;0<D;){var ee=D-1>>>1,N=P[ee];if(0<i(N,j))P[ee]=j,P[D]=N,D=ee;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var j=P[0],D=P.pop();if(D!==j){P[0]=D;e:for(var ee=0,N=P.length,$=N>>>1;ee<$;){var O=2*(ee+1)-1,F=P[O],v=O+1,V=P[v];if(0>i(F,D))v<N&&0>i(V,F)?(P[ee]=V,P[v]=D,ee=v):(P[ee]=F,P[O]=D,ee=O);else if(v<N&&0>i(V,D))P[ee]=V,P[v]=D,ee=v;else break e}}return j}function i(P,j){var D=P.sortIndex-j.sortIndex;return D!==0?D:P.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,a=o.now();e.unstable_now=function(){return o.now()-a}}var s=[],c=[],h=1,g=null,m=3,w=!1,y=!1,k=!1,L=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(P){for(var j=n(c);j!==null;){if(j.callback===null)r(c);else if(j.startTime<=P)r(c),j.sortIndex=j.expirationTime,t(s,j);else break;j=n(c)}}function x(P){if(k=!1,p(P),!y)if(n(s)!==null)y=!0,Ct(E);else{var j=n(c);j!==null&&Ie(x,j.startTime-P)}}function E(P,j){y=!1,k&&(k=!1,f(T),T=-1),w=!0;var D=m;try{for(p(j),g=n(s);g!==null&&(!(g.expirationTime>j)||P&&!ye());){var ee=g.callback;if(typeof ee=="function"){g.callback=null,m=g.priorityLevel;var N=ee(g.expirationTime<=j);j=e.unstable_now(),typeof N=="function"?g.callback=N:g===n(s)&&r(s),p(j)}else r(s);g=n(s)}if(g!==null)var $=!0;else{var O=n(c);O!==null&&Ie(x,O.startTime-j),$=!1}return $}finally{g=null,m=D,w=!1}}var M=!1,A=null,T=-1,Q=5,B=-1;function ye(){return!(e.unstable_now()-B<Q)}function he(){if(A!==null){var P=e.unstable_now();B=P;var j=!0;try{j=A(!0,P)}finally{j?ke():(M=!1,A=null)}}else M=!1}var ke;if(typeof d=="function")ke=function(){d(he)};else if(typeof MessageChannel<"u"){var Ye=new MessageChannel,Re=Ye.port2;Ye.port1.onmessage=he,ke=function(){Re.postMessage(null)}}else ke=function(){L(he,0)};function Ct(P){A=P,M||(M=!0,ke())}function Ie(P,j){T=L(function(){P(e.unstable_now())},j)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){y||w||(y=!0,Ct(E))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(P){switch(m){case 1:case 2:case 3:var j=3;break;default:j=m}var D=m;m=j;try{return P()}finally{m=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,j){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var D=m;m=P;try{return j()}finally{m=D}},e.unstable_scheduleCallback=function(P,j,D){var ee=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?ee+D:ee):D=ee,P){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=D+N,P={id:h++,callback:j,priorityLevel:P,startTime:D,expirationTime:N,sortIndex:-1},D>ee?(P.sortIndex=D,t(c,P),n(s)===null&&P===n(c)&&(k?(f(T),T=-1):k=!0,Ie(x,D-ee))):(P.sortIndex=N,t(s,P),y||w||(y=!0,Ct(E))),P},e.unstable_shouldYield=ye,e.unstable_wrapCallback=function(P){var j=m;return function(){var D=m;m=j;try{return P.apply(this,arguments)}finally{m=D}}}})(Fc);(function(e){e.exports=Fc})(Dc);/**
 * @license React
...
`}}}return l}(this)},e}(),hm=/(a)(d)/gi,pc=function(e){return String.fromCharCode(e+(e>25?39:97))};function Ma(e){var t,n="";for(t=Math.abs(e);t>52;t=t/52|0)n=pc(t%52)+n;return(pc(t%52)+n).replace(hm,"$1-$2")}var Dn=function(e,t){for(var n=t.length;n;)e=33*e^t.charCodeAt(--n);return e},Qf=function(e){return Dn(5381,e)};function Yf(e){for(var t=0;t<e.length;t+=1){var n=e[t];if(Jr(n)&&!Ws(n))return!1}return!0}var mm=Qf("5.3.6"),gm=function(){function e(t,n,r){this.rules=t,this.staticRulesId="",this.isStatic=(r===void 0||r.isStatic)&&Yf(t),this.componentId=n,this.baseHash=Dn(mm,n),this.baseStyle=r,hl.registerId(n)}return e.prototype.generateAndInjectStyles=function(t,n,r){var i=this.componentId,l=[];if(this.baseStyle&&l.push(this.baseStyle.generateAndInjectStyles(t,n,r)),this.isStatic&&!r.hash)if(this.staticRulesId&&n.hasNameForId(i,this.staticRulesId))l.push(this.staticRulesId);else{var o=xn(this.rules,t,n,r).join(""),a=Ma(Dn(this.baseHash,o)>>>0);if(!n.hasNameForId(i,a)){var s=r(o,"."+a,void 0,i);n.insertRules(i,a,s)}l.push(a),this.staticRulesId=a}else{for(var c=this.rules.length,h=Dn(this.baseHash,r.hash),g="",m=0;m<c;m++){var w=this.rules[m];if(typeof w=="string")g+=w;else if(w){var y=xn(w,t,n,r),k=Array.isArray(y)?y.join(""):y;h=Dn(h,k+m),g+=k}}if(g){var L=Ma(h>>>0);if(!n.hasNameForId(i,L)){var f=r(g,"."+L,void 0,i);n.insertRules(i,L,f)}l.push(L)}}return l.join(" ")},e}(),vm=/^\s*\/\/.*$/gm,ym=[":","[",".","#"];function wm(e){var t,n,r,i,l=e===void 0?Zt:e,o=l.options,a=o===void 0?Zt:o,s=l.plugins,c=s===void 0?fl:s,h=new j0(a),g=[],m=function(k){function L(f){if(f)try{k(f+"}")}catch{}}return function(f,d,p,x,E,M,A,T,Q,B){switch(f){case 1:if(Q===0&&d.charCodeAt(0)===64)return k(d+";"),"";break;case 2:if(T===0)return d+"/*|*/";break;case 3:switch(T){case 102:case 112:return k(p[0]+d),"";default:return d+(B===0?"/*|*/":"")}case-2:d.split("/*|*/}").forEach(L)}}}(function(k){g.push(k)}),w=function(k,L,f){return L===0&&ym.indexOf(f[n.length])!==-1||f.match(i)?k:"."+t};function y(k,L,f,d){d===void 0&&(d="&");var p=k.replace(vm,""),x=L&&f?f+" "+L+" { "+p+" }":p;return t=d,n=L,r=new RegExp("\\"+n+"\\b","g"),i=new RegExp("(\\"+n+"\\b){2,}"),h(f||!L?"":L,x)}return h.use([].concat(c,[function(k,L,f){k===2&&f.length&&f[0].lastIndexOf(n)>0&&(f[0]=f[0].replace(r,w))},m,function(k){if(k===-2){var L=g;return g=[],L}}])),y.hash=c.length?c.reduce(function(k,L){return L.name||ri(15),Dn(k,L.name)},5381).toString():"",y}var Gf=kt.createContext();Gf.Consumer;var Xf=kt.createContext(),xm=(Xf.Consumer,new hl),Ta=wm();function Kf(){return R.exports.useContext(Gf)||xm}function Jf(){return R.exports.useContext(Xf)||Ta}var qf=function(){function e(t,n){var r=this;this.inject=function(i,l){l===void 0&&(l=Ta);var o=r.name+l.hash;i.hasNameForId(r.id,o)||i.insertRules(r.id,o,l(r.rules,o,"@keyframes"))},this.toString=function(){return ri(12,String(r.name))},this.name=t,this.id="sc-keyframes-"+t,this.rules=n}return e.prototype.getName=function(t){return t===void 0&&(t=Ta),this.name+t.hash},e}(),Sm=/([A-Z])/,km=/([A-Z])/g,Cm=/^ms-/,Em=function(e){return"-"+e.toLowerCase()};function hc(e){return Sm.test(e)?e.replace(km,Em).replace(Cm,"-ms-"):e}var mc=function(e){return e==null||e===!1||e===""};function xn(e,t,n,r){if(Array.isArray(e)){for(var i,l=[],o=0,a=e.length;o<a;o+=1)(i=xn(e[o],t,n,r))!==""&&(Array.isArray(i)?l.push.apply(l,i):l.push(i));return l}if(mc(e))return"";if(Ws(e))return"."+e.styledComponentId;if(Jr(e)){if(typeof(c=e)!="function"||c.prototype&&c.prototype.isReactComponent||!t)return e;var s=e(t);return xn(s,t,n,r)}var c;return e instanceof qf?n?(e.inject(n,r),e.getName(r)):e:$a(e)?function h(g,m){var w,y,k=[];for(var L in g)g.hasOwnProperty(L)&&!mc(g[L])&&(Array.isArray(g[L])&&g[L].isCss||Jr(g[L])?k.push(hc(L)+":",g[L],";"):$a(g[L])?k.push.apply(k,h(g[L],L)):k.push(hc(L)+": "+(w=L,(y=g[L])==null||typeof y=="boolean"||y===""?"":typeof y!="number"||y===0||w in D0?String(y).trim():y+"px")+";"));return m?[m+" {"].concat(k,["}"]):k}(e):e.toString()}var gc=function(e){return Array.isArray(e)&&(e.isCss=!0),e};function bs(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return Jr(e)||$a(e)?gc(xn(cc(fl,[e].concat(n)))):n.length===0&&e.length===1&&typeof e[0]=="string"?e:gc(xn(cc(e,n)))}var Zf=function(e,t,n){return n===void 0&&(n=Zt),e.theme!==n.theme&&e.theme||t||n.theme},Pm=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,_m=/(^-|-$)/g;function $o(e){return e.replace(Pm,"-").replace(_m,"")}var Qs=function(e){return Ma(Qf(e)>>>0)};function Pi(e){return typeof e=="string"&&!0}var Oa=function(e){return typeof e=="function"||typeof e=="object"&&e!==null&&!Array.isArray(e)},zm=function(e){return e!=="__proto__"&&e!=="constructor"&&e!=="prototype"};function Nm(e,t,n){var r=e[n];Oa(t)&&Oa(r)?ep(r,t):e[n]=t}function ep(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];for(var i=0,l=n;i<l.length;i++){var o=l[i];if(Oa(o))for(var a in o)zm(a)&&Nm(e,o[a],a)}return e}var Ys=kt.createContext();Ys.Consumer;var Mo={};function tp(e,t,n){var r=Ws(e),i=!Pi(e),l=t.attrs,o=l===void 0?fl:l,a=t.componentId,s=a===void 0?function(d,p){var x=typeof d!="string"?"sc":$o(d);Mo[x]=(Mo[x]||0)+1;var E=x+"-"+Qs("5.3.6"+x+Mo[x]);return p?p+"-"+E:E}(t.displayName,t.parentComponentId):a,c=t.displayName,h=c===void 0?function(d){return Pi(d)?"styled."+d:"Styled("+dc(d)+")"}(e):c,g=t.displayName&&t.componentId?$o(t.displayName)+"-"+t.componentId:t.componentId||s,m=r&&e.attrs?Array.prototype.concat(e.attrs,o).filter(Boolean):o,w=t.shouldForwardProp;r&&e.shouldForwardProp&&(w=t.shouldForwardProp?function(d,p,x){return e.shouldForwardProp(d,p,x)&&t.shouldForwardProp(d,p,x)}:e.shouldForwardProp);var y,k=new gm(n,g,r?e.componentStyle:void 0),L=k.isStatic&&o.length===0,f=function(d,p){return function(x,E,M,A){var T=x.attrs,Q=x.componentStyle,B=x.defaultProps,ye=x.foldedComponentIds,he=x.shouldForwardProp,ke=x.styledComponentId,Ye=x.target,Re=function(F,v,V){F===void 0&&(F=Zt);var z=wt({},v,{theme:F}),ue={};return V.forEach(function(G){var K,H,Ce,Ue=G;for(K in Jr(Ue)&&(Ue=Ue(z)),Ue)z[K]=ue[K]=K==="className"?(H=ue[K],Ce=Ue[K],H&&Ce?H+" "+Ce:H||Ce):Ue[K]}),[z,ue]}(Zf(E,R.exports.useContext(Ys),B)||Zt,E,T),Ct=Re[0],Ie=Re[1],P=function(F,v,V,z){var ue=Kf(),G=Jf(),K=v?F.generateAndInjectStyles(Zt,ue,G):F.generateAndInjectStyles(V,ue,G);return K}(Q,A,Ct),j=M,D=Ie.$as||E.$as||Ie.as||E.as||Ye,ee=Pi(D),N=Ie!==E?wt({},E,{},Ie):E,$={};for(var O in N)O[0]!=="$"&&O!=="as"&&(O==="forwardedAs"?$.as=N[O]:(he?he(O,oc,D):!ee||oc(O))&&($[O]=N[O]));return E.style&&Ie.style!==E.style&&($.style=wt({},E.style,{},Ie.style)),$.className=Array.prototype.concat(ye,ke,P!==ke?P:null,E.className,Ie.className).filter(Boolean).join(" "),$.ref=j,R.exports.createElement(D,$)}(y,d,p,L)};return f.displayName=h,(y=kt.forwardRef(f)).attrs=m,y.componentStyle=k,y.displayName=h,y.shouldForwardProp=w,y.foldedComponentIds=r?Array.prototype.concat(e.foldedComponentIds,e.styledComponentId):fl,y.styledComponentId=g,y.target=r?e.target:e,y.withComponent=function(d){var p=t.componentId,x=function(M,A){if(M==null)return{};var T,Q,B={},ye=Object.keys(M);for(Q=0;Q<ye.length;Q++)T=ye[Q],A.indexOf(T)>=0||(B[T]=M[T]);return B}(t,["componentId"]),E=p&&p+"-"+(Pi(d)?d:$o(dc(d)));return tp(d,wt({},x,{attrs:m,componentId:E}),n)},Object.defineProperty(y,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(d){this._foldedDefaultProps=r?ep({},e.defaultProps,d):d}}),y.toString=function(){return"."+y.styledComponentId},i&&Z0(y,e,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0,withComponent:!0}),y}var Ia=function(e){return function t(n,r,i){if(i===void 0&&(i=Zt),!Is.exports.isValidElementType(r))return ri(1,String(r));var l=function(){return n(r,i,bs.apply(void 0,arguments))};return l.withConfig=function(o){return t(n,r,wt({},i,{},o))},l.attrs=function(o){return t(n,r,wt({},i,{attrs:Array.prototype.concat(i.attrs,o).filter(Boolean)}))},l}(tp,e)};["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","marquee","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","textPath","tspan"].forEach(function(e){Ia[e]=Ia(e)});var Rm=function(){function e(n,r){this.rules=n,this.componentId=r,this.isStatic=Yf(n),hl.registerId(this.componentId+1)}var t=e.prototype;return t.createStyles=function(n,r,i,l){var o=l(xn(this.rules,r,i,l).join(""),""),a=this.componentId+n;i.insertRules(a,a,o)},t.removeStyles=function(n,r){r.clearRules(this.componentId+n)},t.renderStyles=function(n,r,i,l){n>2&&hl.registerId(this.componentId+n),this.removeStyles(n,i),this.createStyles(n,r,i,l)},e}();function Lm(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];var i=bs.apply(void 0,[e].concat(n)),l="sc-global-"+Qs(JSON.stringify(i)),o=new Rm(i,l);function a(c){var h=Kf(),g=Jf(),m=R.exports.useContext(Ys),w=R.exports.useRef(h.allocateGSInstance(l)).current;return h.server&&s(w,c,h,m,g),R.exports.useLayoutEffect(function(){if(!h.server)return s(w,c,h,m,g),function(){return o.removeStyles(w,h)}},[w,c,h,m,g]),null}function s(c,h,g,m,w){if(o.isStatic)o.renderStyles(c,tm,g,w);else{var y=wt({},h,{theme:Zf(h,m,a.defaultProps)});o.renderStyles(c,y,g,w)}}return kt.memo(a)}function np(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];var i=bs.apply(void 0,[e].concat(n)).join(""),l=Qs(i);return new qf(l,i)}const _=Ia,$m=_.div`
...
`,yc=_.div`
    margin: 0 0.5rem;
`;var rp={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},Zn=kt.createContext&&kt.createContext(rp),Zl={exports:{}},eo={};/**
 * @license React
...
`;function z1(){return S(w1,{children:[u(x1,{children:"Explore"}),S("ul",{children:[S("li",{children:[u("img",{src:"https://yt3.ggpht.com/ytc/AMLnZu-PjRc81p0qP-ZPWxv8aY4k-4gFRzGEYs3HWbIQ=s176-c-k-c0x00ffffff-no-rj-mo"}),u("span",{children:"Web Dev Simplified very"}),u("span",{children:u(To,{})})]}),S("li",{children:[u("img",{src:"https://yt3.ggpht.com/ytc/AMLnZu_eX41jzTt6cENVn9timgdy-lAg3DJhvod9Ejz_TQ=s176-c-k-c0x00ffffff-no-rj-mo"}),u("span",{children:"Tech With Tim"}),u("span",{children:u(To,{})})]}),S("li",{children:[u("img",{src:"https://yt3.ggpht.com/ytc/AMLnZu-fB-c8gczS81r-VBWgzndcSZgd1zGA2QcYfACHMg=s176-c-k-c0x00ffffff-no-rj-mo"}),u("span",{children:"Traversy Media"}),u("span",{children:u(To,{})})]})]}),S(S1,{children:[u("span",{children:"More"}),u(t1,{})]})]})}function N1(){return S(k1,{children:[S(C1,{children:[u(E1,{children:"Trending"}),S(P1,{children:[S("li",{children:[u(vr,{children:u(gr,{})}),u("span",{children:"Elon Musk On Mars"})]}),S("li",{children:[u(vr,{children:u(gr,{})}),u("span",{children:"Pandas Eating Bamboo"})]}),S("li",{children:[u(vr,{children:u(gr,{})}),u("span",{children:"Pineapple"})]}),S("li",{children:[u(vr,{children:u(gr,{})}),"Biggest Burger"]}),S("li",{children:[u(vr,{children:u(gr,{})}),"Cute Cats"]})]})]}),S(_1,{href:"https://github.com/benny-sit",children:[u("span",{children:"created by benny-sit"}),u(c1,{})]})]})}function R1(){return S(v1,{children:[u(z1,{}),u(N1,{})]})}const L1=({className:e,children:t})=>u(Zn.Provider,{value:{className:e},children:t}),_i=_(L1)`
  height: 1.5rem;
  width: 1.5rem;
...
`);c.length>1&&l(c.length),s&&(s.current.style.height="min-content",s.current.scrollHeight>60&&(s.current.style.height=`${s.current.scrollHeight}px`))},[o]),S(T1,{children:[S(O1,{children:[u("img",{src:"https://randomuser.me/api/portraits/men/22.jpg",alt:"profile"}),S("div",{children:[u("div",{children:"John Doe"}),u("div",{children:"2d ago"})]})]}),u(I1,{children:u("img",{src:"https://images.pexels.com/photos/3408744/pexels-photo-3408744.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",alt:"landscape"})}),S(A1,{children:[e?Oo:Oo.substring(0,250),u("span",{onClick:()=>t(c=>!c),children:Oo.length>250&&(e?"Show Less":"Show More")})]}),u(j1,{children:"10 Comments 5 Shares"}),u($1,{}),S(D1,{children:[S(B1,{children:[u("textarea",{rows:i,onChange:c=>a(c.target.value),placeholder:"Type a comment...",ref:s}),u("img",{src:"https://randomuser.me/api/portraits/men/40.jpg"}),u("button",{children:u(_i,{children:u(ap,{})})})]}),S(U1,{children:[u("button",{onClick:()=>r(c=>!c),children:u(_i,{children:n?u(a1,{className:"red"}):u(o1,{})})}),u("button",{children:u(_i,{children:u(e1,{})})}),u("button",{children:u(_i,{children:u(l1,{})})})]})]})]})}function H1(){return S(M1,{children:[u(je,{}),u(je,{}),u(je,{}),u(je,{}),u(je,{}),u(je,{})]})}/**
...
`;function tv(){const[e,t]=R.exports.useState(!1),[n,r]=R.exports.useState(!1),[i,l]=R.exports.useState(0),o=R.exports.useRef(null);return R.exports.useLayoutEffect(()=>{o!=null&&o.current&&(console.log(o.current.clientHeight),l(a=>o.current.clientHeight))},[e]),S(ev,{className:`${n?"open":""}`,translateY:i,children:[S(Yg,{children:[u(Qg,{className:`${n?"open":""}`,onClick:()=>r(a=>!a),children:u(n1,{})}),S(mp,{children:[u(Pn,{children:S(zi,{to:"/",className:({isActive:a})=>a?"active":"",end:!0,children:[u(Bt,{children:u(s1,{})}),u(Ut,{children:"Home"})]})}),u(Pn,{children:S(zi,{to:"/profile",className:({isActive:a})=>a?"active":"",children:[u(Bt,{children:u(En,{})}),u(Ut,{children:"Profile"})]})}),S(Pn,{className:"highlight",children:[u(Bt,{children:u(Gm,{})}),u(Ut,{children:"New Post"})]}),u(Pn,{children:S(zi,{to:"/messages",className:({isActive:a})=>a?"active":"",children:[u(Bt,{children:u(mr,{})}),u(Ut,{children:"Messages"})]})}),u(Pn,{children:S(zi,{to:"/search",className:({isActive:a})=>a?"active":"",children:[u(Bt,{children:u(op,{})}),u(Ut,{children:"Search"})]})})]})]}),S(Zg,{ref:o,children:[u(Gg,{children:e?S(ml,{children:[u("span",{children:"Online Friends"}),u("span",{className:"sub-text",children:"10"})]}):u("span",{children:"Login"})}),u(qg,{children:e?S(ml,{children:[S(Kg,{children:[S("li",{children:[u("img",{src:"https://randomuser.me/api/portraits/women/76.jpg"}),u("span",{children:"Alexa Johnson"}),S(Ni,{children:[u(En,{}),u(mr,{})]})]}),S("li",{children:[u("img",{src:"https://randomuser.me/api/portraits/men/84.jpg"}),u("span",{children:"John Doe"}),S(Ni,{children:[u(En,{}),u(mr,{})]})]}),S("li",{children:[u("img",{src:"https://randomuser.me/api/portraits/men/87.jpg"}),u("span",{children:"George Smith"}),S(Ni,{children:[u(En,{}),u(mr,{})]})]}),S("li",{children:[u("img",{src:"https://randomuser.me/api/portraits/men/85.jpg"}),u("span",{children:"Alex Doe"}),S(Ni,{children:[u(En,{}),u(mr,{})]})]})]}),u(Jg,{onClick:()=>t(!1),children:"Logout"})]}):S(Xg,{children:[u("input",{type:"text",placeholder:"Username or Email"}),u("input",{type:"password",placeholder:"Password"}),S("div",{children:[u("a",{href:"#",children:"Forgot password?"}),u("a",{href:"#",children:"Register"})]}),u("button",{type:"submit",onClick:()=>t(a=>!a),children:"Login"})]})})]})]})}function nv(){return S(ml,{children:[u(g1,{}),u(H1,{}),u(R1,{})]})}const rv=({className:e,children:t})=>u(Zn.Provider,{value:{className:e},children:t}),Tr=_(rv)`
  height: 1.5rem;
  width: 1.5rem;
  transition: all 0.5s linear;
  position: absolute;
...
`,cv=_.div`
    ...
    align-items: center;
    padding: 0 0.5rem;
`;function dv({title:e}){const[t,n]=R.exports.useState("unseen"),[r,i]=R.exports.useState(e);return R.exports.useEffect(()=>{n("unseen"),setTimeout(()=>{i(e)},300),setTimeout(()=>{n("")},600)},[e]),S(uv,{children:[u("hr",{}),u("span",{className:t,children:r}),u("hr",{})]})}function fv(){return S(cv,{children:[u(je,{}),u(je,{}),u(je,{}),u(je,{}),u(je,{})]})}function pv(){const[e,t]=R.exports.useState("Explore");return S(lv,{children:[S(ov,{children:[u(av,{children:"Search"}),u(iv,{}),S(sv,{children:[u(Tr,{className:"left",children:u(p1,{})}),u("input",{type:"text"}),u(Tr,{className:"right",children:u(Jm,{onClick:()=>t("Result")})})]})]}),u(dv,{title:e}),u(fv,{})]})}const hv=_.div`
    display: flex;
    gap: 0.5rem;
`,mv=_.div`
    display: flex;
...
`,xv=_.div`
    width: calc(var(--container-size) * 6 / 10);
`;function Sv(){return S(wv,{children:[u(je,{}),u(je,{}),u(je,{}),u(je,{})]})}function kv(){return S(xv,{children:[S(yv,{children:[S(hv,{children:[u(gv,{children:u("img",{src:"https://randomuser.me/api/portraits/men/22.jpg"})}),S(mv,{children:[u("span",{className:"title",children:"John Doe"}),u("span",{className:"sub-title",children:"Professional Photographer"}),S("span",{className:"body",children:[S("span",{children:[u(f1,{})," Member Since 2019/7"]}),S("span",{children:[u(Xm,{}),"Last seen today"]}),S("span",{children:[u(Zm,{}),"18 posts last month"]}),S("span",{children:[u(u1,{}),"Tel Aviv, Israel"]})]})]})]}),S(vv,{children:[u("button",{className:"selected",children:"Posts"}),u("button",{children:"followers"}),u("button",{children:"following"})]})]}),u(Sv,{})]})}const Cv=_.div`
    display: flex;
    background-color: white;
    margin-top: 1rem;
    width: 100%;
...
`);o.length>1&&l(o.length),r&&(r.current.style.height="min-content",r.current.scrollHeight>60&&(r.current.style.height=`${r.current.scrollHeight}px`))},[t]),S(Rv,{children:[S(Lv,{children:[S($v,{children:[u("button",{onClick:()=>e(o=>!o),children:u(d1,{})}),u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Online"})]})]}),u(Mv,{children:u(i1,{})})]}),u(Ov,{children:S(Tv,{children:[S(zc,{children:[u(Nc,{children:"John Doe"}),u(Rc,{children:"Hi, John how are you?"})]}),S(zc,{className:"you",children:[u(Nc,{children:"John Doe"}),u(Rc,{children:"Hi, John how are you?"})]})]})}),S(Av,{children:[u("textarea",{rows:i,onChange:o=>n(o.target.value),placeholder:"Message...",ref:r}),u("button",{className:"attach",children:u(qm,{})}),u("button",{className:"send",children:u("span",{children:u(ap,{})})})]})]})}function Dv(){const[e,t]=R.exports.useState(!1);return S(Cv,{children:[S(Ev,{className:`${e?"open":""}`,children:[S(Pv,{children:[u("span",{children:"Messages"}),u("button",{onClick:()=>t(!1),children:u(r1,{})})]}),S(_v,{children:[u("input",{type:"text",placeholder:"filter Messages..."}),u("button",{children:u(op,{})})]}),S(zv,{children:[S("li",{className:"selected",children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?ddddddddddddddddddddddddddddddddd"})]}),u("span",{className:"unread",children:"6"})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]}),u("span",{className:"unread",children:"5"})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]}),S("li",{children:[u("img",{src:"https://via.placeholder.com/128x128.png",alt:"chat-icon"}),S("div",{children:[u("span",{children:"John Doe"}),u("span",{children:"Hi, how are you doing today?"})]})]})]}),u(Nv,{children:u("span",{children:"+ New Chat"})})]}),u(jv,{setOpen:t})]})}function Fv(){return S(Ag,{children:[u(kr,{path:"/",element:u(nv,{})}),u(kr,{path:"/search",element:u(pv,{})}),u(kr,{path:"/profile",element:u(kv,{})}),u(kr,{path:"/messages",element:u(Dv,{})})]})}function Bv(){return S(Ug,{children:[u(Mm,{}),u(tv,{}),u("main",{children:u($m,{children:u(Fv,{})})})]})}Do.createRoot(document.getElementById("root")).render(u(kt.StrictMode,{children:u(Bv,{})}));
